...
>>>>>>> 396bc3389b333dbfb9fd4aa5368038c0166ed8de
            onClick={() => router.push('/')}
...
>>>>>>> 396bc3389b333dbfb9fd4aa5368038c0166ed8de
          <div className="flex justify-end pt-2">
            <button
              onClick={handleSaveTraining}
              className="bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-2xl font-bold flex items-center gap-2 transition-all shadow-lg shadow-green-200 active:scale-95"
            >
